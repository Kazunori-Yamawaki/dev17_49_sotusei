...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">利用者情報更新／退会</div>
...
<!--郵便番号入力-->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal" type="tel" class="form-control" name="postal" value="{{$user->postal}}" autocomplete="postal-code">
                            </div>
                        </div>
...
<!--電話番号入力-->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="tel" class="form-control" name="tel" value="{{$user->tel}}" autocomplete="tel">
                            </div>
                        </div>
